...
class TaskRequesterRunner:
    ...
    def iter_tasks(self, output_path, root_path):
        ...
        for folder in folders:
            ...
            for index, file in enumerate(files):
                ...
                self.solve_problem(file_path, task_name)

                if index % 5 == 0:
                    with open(output_path, "w", encoding="utf-8") as f:
                        json.dump(self.answers, f, ensure_ascii=False, indent=2)

    def solve_problem(self, file_path, task_name):
...
if __name__ == "__main__":
    ...
    runner.start()
    runner.answers = []
    runner.solve_problem(file_path="/workspace/Symphony_GradientNetwork/test.json", task_name="test")
    output_path = "/workspace/Symphony_GradientNetwork/tasks.json"
    with open(output_path, "w", encoding="utf-8") as f:
        json.dump(runner.answers, f, ensure_ascii=False, indent=2)
